...
vidUrl = "" #Change YOUR_URL to any TikTok video URL
username = "" #Change YOUR_USERNAME to the username of the user that uploaded the TikTok video

system("cls")
bottok = pyfiglet.figlet_format("Insert Name Here", font="slant")
print(bottok)
print("github.com/TheHike")
print("")
